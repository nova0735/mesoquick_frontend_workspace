    ...
    <div className="space-y-4 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <select name="bankAccountType" value={dto.bankAccountType || ''} onChange={handleChange} 
        ...
        <div>
          <label className="block text-sm text-gray-600 mb-1">ID del Banco</label>
          <input type="text" name="bankId" value={dto.bankId || ''} onChange={handleChange} 
