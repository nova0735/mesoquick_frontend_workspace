...
export const Step2Documentation: React.FC = () => {
  const { dto, updateData, updateFiles } = useWizardStore();
    ...
    <div className="space-y-4 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input type="text" name="cui" value={dto.cui || ''} onChange={handleTextChange} 
        ...
        <div>
          ...
          <input type="text" name="nit" value={dto.nit || ''} onChange={handleTextChange} 
                 className="w-full border border-gray-300 rounded p-2 focus:border-[#3c606b] outline-none" />
        </div>
      </div>
